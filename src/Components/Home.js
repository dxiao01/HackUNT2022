...
const Home = () => {
	...
	return (
		<div class="h-full mb-4 scrollbar-hide">
			...
			<div
				class=" text-left text-3xl font-extrabold mt-48 ml-72"
				data-aos="fade-right"
			>
				Your Universe for All Things Space!
			</div>
			<div
				class="text-left text-3xl font-bold my-48 mx-60 float-left"
				data-aos="fade-left"
			>
			...
			<div class="max-w-6xl px-12 mx-auto text-center mb-10">
				<div class="space-y-12 md:text-center" data-aos="fade-up">
					<div class="max-w-3xl mb-10 space-y-5 sm:mx-auto sm:space-y-4">
						<h2 class="relative text-4xl font-extrabold tracking-tight sm:text-5xl mt-10">
							About Us
						</h2>
					</div>
				</div>
				...
				<div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
					<div
						class="w-full border border-gray-200 rounded-lg shadow-lg"
						data-aos="flip-down"
					>
