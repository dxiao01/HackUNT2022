...
const Home = () => {
  ...
  return (
    <div class="h-full mb-4 scrollbar-hide bg-gray-900">
        <shooting-stars image={star} height="5" width="200" min-speed="20" max-speed="30" num="70"></shooting-stars>
        <div class="text-center text-8xl font-extrabold text-white" data-aos="fade-up">Spaceverse</div>
        <div class=" text-center text-3xl font-extrabold mt-48 text-white" data-aos="fade-right">Your Universe for All Things Space!</div>
        <div class="text-center text-2xl font-extrabold my-48 mx-60 float-left text-white" data-aos="fade-left">
        ...
        <div class="max-w-6xl px-12 mx-auto text-center mb-10">
            <div class="space-y-12 md:text-center" data-aos="fade-up">
                <div class="max-w-3xl mb-10 space-y-5 sm:mx-auto sm:space-y-4">
                    <h2 class="relative text-4xl font-extrabold tracking-tight sm:text-5xl mt-10 text-white">About Us</h2>
                </div>
            </div>
